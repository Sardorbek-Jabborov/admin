<template>
  <div class="relative">
    ...
    <div class="mt-5 mx-10 flex justify-between">
      <div class="inline-flex gap-2 items-center bg-white py-2 px-3 rounded-xl">
        <div>
        ...
        <div>
          <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M19.9999 11.9999H4.00007" stroke="white" stroke-width="2" stroke-linecap="round"
                  stroke-linejoin="round" class="group-hover:stroke-blue-300 transition-all duration-300 ease-in-out"/>
